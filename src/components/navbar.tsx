      ...
      <nav className="fixed z-10 w-full mx-auto bg-white/40 bg-opacity-80 border-gray-200 px-2 sm:px-4 py-2.5 rounded drop-shadow-lg">
        <div className="max-w-[1080px] container flex flex-wrap justify-between items-center mx-auto">
          <Link href="/" className="flex items-center flex-1">
            <span className="flex flex-row items-center self-center text-xl font-bold whitespace-nowrap text-[#FF684B] hover:text-[#ED5032]">
              <Image
                src="/Scroll.png"
                width="50"
                height="50"
                  ...
                  <PopoverContent color='white' bg='blue.800' borderColor='blue.800'>
                    ...
                    >
                      <Stack direction={"row"} align={"center"}>
                        <Box>
                          <Text className="font-semibold pb-1 transition ease-in-out delay-10 group-hover:white-400 text-gray-600 hover:text-[#FF684B]">
                            {"Create Profile"}
                          </Text>
                        </Box>
